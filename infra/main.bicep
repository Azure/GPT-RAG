...
var _vnetResourceGroupName = !empty(vnetResourceGroupName) ? vnetResourceGroupName : '${abbrs.managementGovernance.resourceGroup}${environmentName}'
...
resource vnetrg 'Microsoft.Resources/resourceGroups@2024-11-01' = {
...
module vnet './core/network/vnet.bicep' = if (_networkIsolation && !_vnetReuse || useAKS) {
...
var appSettings = [
  ...
  }
  {
    ...
    value: (useMCP)?'${mcpServer.outputs.uri}/sse':''
  }
  {
...
module mcpServer  'core/host/appservice.bicep' = if(!useACA && !useAKS && useMCP) {
  name: 'mcpServer'
  scope: rg
  params: {
...
module storageAccess './core/security/resource-group-role-assignment.bicep' = if (useACA) {
  name: 'storageAccess'
  scope: rg
  params: {
...
module network './core/util/virtualNetworkData.bicep' = if (_networkIsolation && !_vnetReuse || useAKS) {
...
var subnets = (_networkIsolation && !_vnetReuse || useAKS) ? reduce(
