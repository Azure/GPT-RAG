...
[Pre-release {{ latest_release_candidate("azure/gpt-rag") }} :material-tag: ]({{ latest_release_candidate_url("azure/gpt-rag") }}){ data-md-color-accent="orange" .md-button--pill .md-button--pill--rc }
